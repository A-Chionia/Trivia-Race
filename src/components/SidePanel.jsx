  ...
  const startGame = (index) => {
    ...
    return (
        <div style={panelStyle}>
          ...
          {fluidWorks === false && <p>There is an issue with your connection. Please restart the application.</p>}
          {fluidWorks === true && !gameStarted && <div>
            <p>Play against the other participants and race against time!</p>
            
            {!gameStarted && <div style={verticalButtons}>
            <p>Choose your speed: </p>
            {speedOptions.map((speedOption, index) => (
                <button
                    key={index}
                    style={selectedSpeedIndex === index ? activeButtonStyle : buttonStyle}
            ...
            {scoreboard.length > 1 && gameStarted && <div style={scoreStyle}>
